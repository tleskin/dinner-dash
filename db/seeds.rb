...
Item.create(title: "Egg-Plant Quinoa", description: "'Herb'- crusted eggplant, served with that special sauce", price: 2000).categories << Category.find(1)
...
Item.create(title: "PRB", description: "Wet your whistle with this special prize", price: 2000).categories << Category.find(2)
...
Item.create(title: "", description: "Grass-fed all soy free range Breadstick", price: 2000).categories << Category.find(4)
Item.create(title: "Vintage Venison Bites", description: "35 year old venison chuncked into ", price: 2000).categories << Category.find(4)
Item.create(title: "Da Freshest Seaweed", description: "Local caught seaweed", price:2000).categories << Category.find(4)
