...
Item.create(title: "Tatted Fingers", description: "Large, and in charge, plantains drizzled in style .", price: 2000)
...
Item.create(title: "Alternative Artichokes", description: "These grilled artichokes will make you emo", price: 8000)
Item.create(title: "Grunge burger", description: "Greasy, oily and loud", price:5500)
